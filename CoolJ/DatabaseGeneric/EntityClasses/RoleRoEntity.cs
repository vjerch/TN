...
namespace NinjaSoftware.TrzisteNovca.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
			...
			bool isSortAscending)
        {
            ...
            Type sortEntityFieldType = typeof(RoleRoFields);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), (IEntityRelation)GetRelationsForField("UserCollection")[0], (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.RoleRoEntity, (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.UserEntity, 0, null, null, null, null, "UserCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<UserEntity, UserEntityFactory>("Role", true, false, ref _userCollection);	}
		}
		...
		{ 
			get { return (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.RoleRoEntity; }
		}
