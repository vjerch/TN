...
namespace NinjaSoftware.TrzisteNovca.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", NinjaSoftware.TrzisteNovca.CoolJ.RelationClasses.StaticUserRelations.RoleRoEntityUsingRoleIdStatic, true, signalRelatedEntity, "UserCollection", resetFKFields, new int[] { (int)UserFieldIndex.RoleId } );
			_role = null;
		}
		...
		private void SetupSyncRole(IEntityCore relatedEntity)
		{
			if(_role!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", NinjaSoftware.TrzisteNovca.CoolJ.RelationClasses.StaticUserRelations.RoleRoEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("AuditInfoCollection")[0], (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.UserEntity, (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.AuditInfoEntity, 0, null, null, null, null, "AuditInfoCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleRoEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.UserEntity, (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.RoleRoEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual RoleRoEntity Role
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserCollection", "Role", _role, true); 
				}
			}
		}
		...
		{ 
			get { return (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.UserEntity; }
		}
