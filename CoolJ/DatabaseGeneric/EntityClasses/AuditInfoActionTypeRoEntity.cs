...
namespace NinjaSoftware.TrzisteNovca.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("AuditInfoCollection")[0], (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.AuditInfoActionTypeRoEntity, (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.AuditInfoEntity, 0, null, null, null, null, "AuditInfoCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.AuditInfoActionTypeRoEntity; }
		}
