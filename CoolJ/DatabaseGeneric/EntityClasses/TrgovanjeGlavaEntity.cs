...
namespace NinjaSoftware.TrzisteNovca.CoolJ.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'TrgovanjeGlava'.<br/><br/></summary>
	[Serializable]
	[JsonObject(MemberSerialization.OptIn)]	
	public partial class TrgovanjeGlavaEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			EntityCollection entityCollection = new EntityCollection(new TrgovanjeGlavaEntityFactory());
        ...
        public static EntityCollection<TrgovanjeGlavaEntity> FetchTrgovanjeGlavaCollectionForPaging(DataAccessAdapterBase adapter,
			...
			bool isSortAscending)
        {
            ...
            Type sortEntityFieldType = typeof(TrgovanjeGlavaFields);
            ...
            EntityCollection<TrgovanjeGlavaEntity> toReturn = new EntityCollection<TrgovanjeGlavaEntity>(new TrgovanjeGlavaEntityFactory());
		...
		public static TrgovanjeGlavaEntity FetchTrgovanjeGlava(DataAccessAdapterBase adapter, PrefetchPath2 prefetchPath, long TrgovanjeGlavaId)
		{
			TrgovanjeGlavaEntity _TrgovanjeGlavaEntity = new TrgovanjeGlavaEntity(TrgovanjeGlavaId);
			adapter.FetchEntity(_TrgovanjeGlavaEntity, prefetchPath);
			return _TrgovanjeGlavaEntity;
		}

		#endregion
		
		/// <summary> Static CTor for setting up custom property hashtables. Is executed before the first instance of this entity class or derived classes is constructed. </summary>
		static TrgovanjeGlavaEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public TrgovanjeGlavaEntity():base("TrgovanjeGlavaEntity")
		{
		...
		public TrgovanjeGlavaEntity(IEntityFields2 fields):base("TrgovanjeGlavaEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TrgovanjeGlavaEntity</param>
		public TrgovanjeGlavaEntity(IValidator validator):base("TrgovanjeGlavaEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="trgovanjeGlavaId">PK value for TrgovanjeGlava which data should be fetched into this TrgovanjeGlava object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TrgovanjeGlavaEntity(System.Int64 trgovanjeGlavaId):base("TrgovanjeGlavaEntity")
		{
			InitClassEmpty(null, null);
			this.TrgovanjeGlavaId = trgovanjeGlavaId;
		}
		...
		/// <param name="validator">The custom validator object for this TrgovanjeGlavaEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TrgovanjeGlavaEntity(System.Int64 trgovanjeGlavaId, IValidator validator):base("TrgovanjeGlavaEntity")
		{
			InitClassEmpty(validator, null);
			this.TrgovanjeGlavaId = trgovanjeGlavaId;
		}
		...
		protected TrgovanjeGlavaEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "TrgovanjeStavkaCollection":
					toReturn.Add(Relations.TrgovanjeStavkaEntityUsingTrgovanjeGlavaId);
					break;
				default:
					break;				
			}
		...
		{
			return new TrgovanjeGlavaRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTrgovanjeStavkaCollection()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TrgovanjeStavkaFields.TrgovanjeGlavaId, null, ComparisonOperator.Equal, this.TrgovanjeGlavaId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TrgovanjeGlavaEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("Komentar", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this TrgovanjeGlavaEntity</param>
		...
		public  static TrgovanjeGlavaRelations Relations
		{
			get	{ return new TrgovanjeGlavaRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<TrgovanjeStavkaEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TrgovanjeStavkaEntityFactory))), (IEntityRelation)GetRelationsForField("TrgovanjeStavkaCollection")[0], (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.TrgovanjeGlavaEntity, (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.TrgovanjeStavkaEntity, 0, null, null, null, null, "TrgovanjeStavkaCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The ConcurrencyGuid property of the Entity TrgovanjeGlava<br/><br/></summary>
		/// <remarks>Mapped on  table field: "TrgovanjeGlava"."ConcurrencyGuid"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		[JsonProperty]		
		public virtual System.String ConcurrencyGuid
		{
			get { return (System.String)GetValue((int)TrgovanjeGlavaFieldIndex.ConcurrencyGuid, true); }
			set	{ SetValue((int)TrgovanjeGlavaFieldIndex.ConcurrencyGuid, value); }
		}

		/// <summary> The Datum property of the Entity TrgovanjeGlava<br/><br/></summary>
		/// <remarks>Mapped on  table field: "TrgovanjeGlava"."Datum"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		[JsonProperty]		
		public virtual System.DateTime Datum
		{
			get { return (System.DateTime)GetValue((int)TrgovanjeGlavaFieldIndex.Datum, true); }
			set	{ SetValue((int)TrgovanjeGlavaFieldIndex.Datum, value); }
		}

		/// <summary> The Komentar property of the Entity TrgovanjeGlava<br/><br/></summary>
		/// <remarks>Mapped on  table field: "TrgovanjeGlava"."Komentar"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		[JsonProperty]		
		public virtual System.String Komentar
		{
			get { return (System.String)GetValue((int)TrgovanjeGlavaFieldIndex.Komentar, true); }
			set	{ SetValue((int)TrgovanjeGlavaFieldIndex.Komentar, value); }
		}

		/// <summary> The TrgovanjeGlavaId property of the Entity TrgovanjeGlava<br/><br/></summary>
		/// <remarks>Mapped on  table field: "TrgovanjeGlava"."TrgovanjeGlavaId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		[JsonProperty]		
		public virtual System.Int64 TrgovanjeGlavaId
		{
			get { return (System.Int64)GetValue((int)TrgovanjeGlavaFieldIndex.TrgovanjeGlavaId, true); }
			set	{ SetValue((int)TrgovanjeGlavaFieldIndex.TrgovanjeGlavaId, value); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<TrgovanjeStavkaEntity, TrgovanjeStavkaEntityFactory>("TrgovanjeGlava", true, false, ref _trgovanjeStavkaCollection);	}
		}
		...
		{ 
			get { return (int)NinjaSoftware.TrzisteNovca.CoolJ.EntityType.TrgovanjeGlavaEntity; }
		}
