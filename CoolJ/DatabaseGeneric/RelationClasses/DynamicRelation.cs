...
namespace NinjaSoftware.TrzisteNovca.CoolJ.RelationClasses
{
	...
	public class DynamicRelation : DynamicRelationBase
	{
		...
		/// <param name="onClause">The on clause for the join.</param>
		public DynamicRelation(DerivedTableDefinition leftOperand, JoinHint joinType, NinjaSoftware.TrzisteNovca.CoolJ.EntityType rightOperand, string aliasRightOperand, IPredicate onClause)
		{
