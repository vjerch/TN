...
namespace NinjaSoftware.TrzisteNovca.CoolJ.FactoryClasses
{
	...
	{
		private static readonly Dictionary<NinjaSoftware.TrzisteNovca.CoolJ.EntityType, string> _entityTypeNamesCache = new Dictionary<NinjaSoftware.TrzisteNovca.CoolJ.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(NinjaSoftware.TrzisteNovca.CoolJ.EntityType value in Enum.GetValues(typeof(NinjaSoftware.TrzisteNovca.CoolJ.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(NinjaSoftware.TrzisteNovca.CoolJ.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(NinjaSoftware.TrzisteNovca.CoolJ.EntityType relatedEntityType)
		{
